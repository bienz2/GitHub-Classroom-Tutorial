...
\textbf{Before getting started, you will need a GitHub account and a way to edit repositories.  If you do not already have a GitHub authentification token or SSH key setup, a step-by-step guide is available \href{https://teaching.amandabienz.com/github-token.html}{here}.}\\
...
\begin{enumerate}
    ...
    \includegraphics[width=0.75\textwidth]{Homework/figs/4_submodule.jpg}
    ...
    \includegraphics[width=0.75\textwidth]{Homework/figs/5_configure.jpg}\\
    ...
    \includegraphics[width=0.75\textwidth]{Homework/figs/6_configure.jpg}
    ...
    \includegraphics[width=0.75\textwidth]{Homework/figs/7_compile.jpg}
    ...
    \includegraphics[width=0.75\textwidth]{Homework/figs/8_cmake.jpg}
    ...
    \includegraphics[width=0.75\textwidth]{Homework/figs/9_googletest.jpg}

    \item [(3.4)] This is what your `compile.sh` script should look like.\\
    \includegraphics[width=0.75\textwidth]{Homework/figs/10config.png}
    ...
    \includegraphics[width=0.75\textwidth]{Homework/figs/pass_autograder.png}\\
    ...
    \includegraphics[width=0.75\textwidth]{Homework/figs/pass_test.png}
\end{enumerate}
...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \includegraphics[width=0.75\textwidth]{Homework/figs/error_submodule.png}
        ...
        \includegraphics[width=0.75\textwidth]{Homework/figs/error_code.png}

        
        \item If your unit test fails, your return0 function does not return the number 0.\\
        \includegraphics[width=0.75\textwidth]{Homework/figs/error_test.png}
    \end{enumerate}
    ...
    \begin{enumerate}
        ...
        \includegraphics[width=0.75\textwidth]{Homework/figs/updates.png}
        ...
        \includegraphics[width=0.75\textwidth]{Homework/figs/untracked.png}

        \item The image below indicates you have already added files, but have not committed or pushed.  Commit and push these files.\\
        \includegraphics[width=0.75\textwidth]{Homework/figs/added.png}
        ...
        \includegraphics[width=0.75\textwidth]{Homework/figs/clean_dir.png}
    \end{enumerate}
    ...
    \begin{enumerate}
        ...
        \includegraphics[width=0.75\textwidth]{Homework/figs/detached.png}    
    
        \item To fix this, you can create a new branch and merge it into the correct branch, as shown in the following image.\\
        \includegraphics[width=0.75\textwidth]{Homework/figs/fix_detached.png}
    \end{enumerate}
\end{enumerate}
